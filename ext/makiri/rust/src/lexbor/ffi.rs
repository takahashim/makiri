...
pub use crate::lexbor_abi::{
    ...
    lxb_dom_document_destroy_text_noi, lxb_dom_document_root, lxb_dom_document_type_public_id_noi,
    ...
    lxb_dom_node_name, lxb_dom_node_text_content, lxb_dom_node_type_noi,
    lxb_dom_processing_instruction_target_noi, lxb_ns_by_id, CssParser, LxbAttr, LxbElement,
};
