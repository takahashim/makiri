...
/// The anchored Ruby-String view, from `bridge::string` - one definition for
/// the whole crate. Not `crate::text::BorrowedText`, which has no Ruby anchor.
pub use crate::bridge::string::{ruby_verified_text, RubyText};

pub use crate::bridge::wrapper::XML_NODE_TYPE;
