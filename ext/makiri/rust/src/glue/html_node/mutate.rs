...
//!
//! The implementations live in the Ruby <-> Lexbor seam ([`crate::bridge::lexbor`]),
...
pub use crate::bridge::lexbor::{
    add_child, after, aset, before, create_comment, create_document_fragment,
    create_document_type, create_element, create_pi, create_text_node, delete, lshift, remove,
    remove_attribute_ns, replace, set_attribute_ns, set_content, set_inner_html, set_name,
    set_outer_html,
};
